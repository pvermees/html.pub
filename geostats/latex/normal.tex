...
\noindent\includegraphics[]{../figures/quakerug.pdf}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/CLTfaithful1.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/CLTfaithful2.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/CLTfaithful3.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/CLTfaithful10.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\noindent\begin{minipage}[t][][b]{.55\textwidth}
  \includegraphics[]{../figures/galtonsbeanmachine.pdf}\medskip
\end{minipage}
...
\noindent\includegraphics[]{../figures/pop2d.pdf}
...
\noindent\includegraphics[]{../figures/rand2d.pdf}
...
\noindent\includegraphics[]{../figures/rand2dsum.pdf}
...
\noindent\begin{minipage}[t][][b]{.45\textwidth}
  \includegraphics[]{../figures/norm2dmarginal.pdf}\medskip
\end{minipage}
...
\noindent\includegraphics[]{../figures/musigma.pdf}
...
\noindent\includegraphics[]{../figures/2sigma.pdf}
...
\noindent\includegraphics[]{../figures/cov.pdf}
