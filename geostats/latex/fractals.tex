...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/recentquakes.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/recentlogquakes.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/gutenberg.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{ Bivariate scatter plot of
    ...
    $N_\circ$ is the total number of registered earthquakes, which is
    20,000 for the dataset of Figure~\ref{fig:recentquakes}.  }
  \label{fig:gutenberg}
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/Finland.png}
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{A map of central Finland (axis labels mark
    ...
    lakes''. But in reality there are far more than 1000 lakes in
    ...
    few big ones that cover areas of more than
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/Finland.pdf}
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
...
\noindent\includegraphics[]{../figures/britain.pdf}
\begingroup
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/loglogbritain.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Setting out the length of the British coastline
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/fractaldimbritain.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
...
\noindent\includegraphics[]{../figures/Britainboxes.png}
...
Figure~\ref{fig:fractaldimbritain}, but a similar slope:\medskip

\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/Britainboxcounts.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Plotting the number of boxes against their size
    (i.e. width in pixels) on a log-log diagram yields a linear array
    with a slope of $-1.26$.  This is similar to the value obtained by
    the polygonal line segment method of
...
\noindent\includegraphics[]{../figures/Corsica.png}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/Corsicaboxcounts.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
...
\noindent\begin{minipage}[t][][b]{.5\textwidth}
  \includegraphics[]{../figures/koch1.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.5\textwidth}
  \includegraphics[]{../figures/koch2.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.5\textwidth}
...
\noindent\begin{minipage}[t][][b]{.5\textwidth}
  \includegraphics[]{../figures/koch3.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.5\textwidth}
...
\noindent\begin{minipage}[t][][b]{.5\textwidth}
  \includegraphics[]{../figures/koch6.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.5\textwidth}
...
\noindent\includegraphics[]{../figures/koch.png}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/kochboxcounts.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Log-log plot setting out the number of boxes
    needed to cover the Koch curve of Figure~\ref{fig:koch6} against
    the size of those boxes.  The best fitting line has a slope of
    $-1.26$, which is similar to the slope of the box-counting results
    for the British coastline (Figure~\ref{fig:Britainboxcounts}).
    Box sizes are expressed in arbitrary units (pixel widths).}
...
\noindent\includegraphics[]{../figures/sierpinski.pdf}
\begingroup \captionof{figure}{The \textbf{Sierpinski carpet} is
  ...
  recursion replaces each black square with the same pattern. From
  left to right, this figure shows the first four levels of recursion
  for this algorithm. The end result is an arrangement of small and
  large holes that shares many characteristics with the size
  distribution of Finnish lakes shown in
  Figure~\ref{fig:Finland}.\medskip }
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/sierpinskiboxcounts.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{Log-log plot of the box counting results for the
    Sierpinski carpet. Note how the slope of the best fitting line
    ($-1.89$) is steeper than that of the Koch curve
    (Figure~\ref{fig:kochboxcounts}). It is similar to the slope that
    would be obtained by box-counting the Finnish lakes of
    Figure~\ref{fig:Finland}, which is similar to $x-1$ where $x$ is
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/cantor.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/cantorloglog.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
  \captionof{figure}{The y-axis shows the number of linear segments in
    ...
    $D=\ln[2]/\ln[3]=0.631$. With a fractal dimension between zero and
    one, the Cantor set falls somewhere between a point and a line.}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/pendulum.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
...
\noindent\begin{minipage}[t][][b]{.33\textwidth}
  \includegraphics[]{../figures/3magnets1.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.33\textwidth}
  \includegraphics[]{../figures/3magnets2.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.67\textwidth}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/3magnets.png}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
  \captionof{figure}{This intricate picture paints the initial
    ...
    complex further away. It has all the characteristics of a fractal,
    exhibiting the same level of complexity regardless of scale. The
    pattern is determinisitic in the sense that the same grid of
    initial conditions produces exactly the same pattern. But it is
    chaotic because even tiny changes in the initial position or
    velocity may produce completely different patterns.  }
  \label{fig:3magnets}
\end{minipage}

The strong sensitivity of the outcome on the initial conditions of the
magnetic pendulum experiment is the hallmark of \textbf{deterministic
