...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/RbSr.pdf}\\
\end{minipage}
...
\noindent\includegraphics[]{../figures/r.pdf} \begingroup
...
\noindent\begin{minipage}[t][][b]{.6\textwidth}
  \includegraphics[]{../figures/tr.pdf}\\
\end{minipage}
...
\noindent\includegraphics[]{../figures/tryRbSr.pdf}
...
\noindent\begin{minipage}[t][][b]{.33\textwidth}
  \includegraphics[]{../figures/envelope.pdf}\\
\end{minipage}
...
\noindent\includegraphics[]{../figures/prediction-interval.pdf}
...
\includegraphics[]{../figures/regression-p-hacking.pdf}
...
\noindent\begin{minipage}[t][][b]{.3\linewidth}
  \includegraphics[]{../figures/regression-outlier.pdf}
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{\linewidth}
\includegraphics[]{../figures/spurious.pdf}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/errorfit.pdf}
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.65\textwidth}
  \includegraphics[]{../figures/yorkfit.pdf}
\end{minipage}
